...
<div class="form-group">
    <label>* Título:</label>
    <input type="text" name="title" class="form-control" placeholder="Título:" value="{{ $service->title ?? old('title') }}">
</div>

<div class="form-group">
    <label>* Descrição:</label>
    <textarea name="description" ols="30" rows="5" class="form-control">{{ $service->description ?? old('description') }}</textarea>
</div>
<div class="form-group">
